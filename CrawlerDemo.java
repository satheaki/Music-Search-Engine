...
public class CrawlerDemo extends WebCrawler {
	...
	boolean append = true;
	public static String fileName = "C:\\My files\\Information Retrieval\\Music Sites Raw Data\\JamendoTempData\\jamendo";
	...
	public boolean shouldVisit(Page referringPage, WebURL url) {
		...
		return !FILTERS.matcher(href).matches()
				&& href.startsWith("https://www.jamendo.com/community/pop/tracks");
	}
	...
	public void visit(Page page) {
		...
		if (page.getParseData() instanceof HtmlParseData) {
			...
			// File file1 = new
			// File(fileName+"_"+Integer.toString(count)+"_"+url+".txt");
